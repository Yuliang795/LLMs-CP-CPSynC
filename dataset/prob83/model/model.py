...
def ref_model(param_dict):
    w_rankings = convert_to_namedtuples({"w":param_dict['women_rankings']}).w
    m_rankings = convert_to_namedtuples({"m":param_dict['men_rankings']}).m
    n = len(w_rankings)
